...
/**
 * Generated class for the AddpromoPage page.
 *
...
// Always get the accurate path to your apps folder
  ...
  public uploadImage() {
    ...
    // Destination URL
    var url = "https://mavaeed.herokuapp.com/upload/promo/doctor/" + this.email1;
    ...
    var options = {
      ...
      params: {title: this.title, description: this.discription, discount: this.discount}
    ...
    fileTransfer.upload(targetPath, url, options).then(data => {
      ...
      console.log(data);
      this.Dismiss4()
      this.presentToast('Promo succesfully uploaded.');
